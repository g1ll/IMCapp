...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.calc);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText peso = (EditText) findViewById(R.id.peso);
                EditText altura = (EditText) findViewById(R.id.alt);
                IMC imc = new IMC(
                        Float.parseFloat(peso.getText().toString()),
                        Float.parseFloat(altura.getText().toString()));
                TextView resultview = (TextView ) findViewById(R.id.result);
                String resulttext = "Seu IMC é : " + imc.toString();
